...
define('MAIL_FROM', 'administrator@belajarlean.com');
...
define('DB_USERNAME', 'u931597255_root');

// Mysql/Postgres password
define('DB_PASSWORD', 'belajarlean1');

// Mysql/Postgres hostname
define('DB_HOSTNAME', 'mysql.hostinger.co.id');

// Mysql/Postgres database name
define('DB_NAME', 'u931597255_knbrd');
